...
public class SosService extends Service {
    ...
    private void startAlarm() {
        try {
            // Max out the alarm stream volume
            audioManager.setStreamVolume(
                AudioManager.STREAM_ALARM,
                audioManager.getStreamMaxVolume(AudioManager.STREAM_ALARM),
                0);

            // Use our own bundled siren — no dependency on phone alarm settings
            alarmPlayer = MediaPlayer.create(this, R.raw.sos_alarm);
            if (alarmPlayer == null) {
                Log.e("SosService", "MediaPlayer.create returned null for sos_alarm");
                return;
            }
            ...
            Log.e("SosService", "Alarm start failed: " + e.getMessage());
        }
    }
    ...
    private void createChannels() {
        ...
        // No channel sound — the alarm is played by our own MediaPlayer (R.raw.sos_alarm)
